...
// Cijene su izražene sa PDV-om (MPC) kako bi se prikazivale korisniku
// SKU-ovi i Nazivi su usklađeni sa master Excel tablicom korisnika
...
const prices = {
    ...
    membranes: {
        ...
        geotextile_200: { price: 0.81, sku: "2124", name: "Geotekstil, 200g" },
        geotextile_300: { price: 0.98, sku: "2125", name: "Geotekstil, 300g" }
    },

    bitumen: {
        diamond_p4: { price: 4.98, sku: "2117", name: "RAVAPROOF Diamond P 4, SBS, Polyester, s posipom, sivi" },
        ruby_v4: { price: 3.71, sku: "2118", name: "RAVAPROOF Ruby V-4" },
        sapphire_g3: { price: 2.03, sku: "2119", name: "RAVAPROOF Sapphire G3" },
        sapphire_g4: { price: 2.70, sku: "2120", name: "RAVAPROOF Sapphire G4" },
        vapor_al: { price: 4.73, sku: "2121", name: "RAVAPROOF Vapor Al-35 (3,5mm) , SBS" }
    },
    ...
    fence: {
        // 2D PANELI
        panel_2d: {
            83: { price: 25.68, sku: "1001", name: "Ogradni panel 2D 830x2500 6/5/6" },
            103: { price: 28.93, sku: "1002", name: "Ogradni panel 2D 1030x2500 6/5/6" },
            123: { price: 33.80, sku: "1003", name: "Ogradni panel 2D 1230x2500 6/5/6" },
            ...
            203: { price: 54.60, sku: "1007", name: "Ogradni panel 2D 2030x2500 6/5/6" }
        },

        // 3D PANELI (5mm)
        panel_3d_5: {
            83: { price: 18.90, sku: "1018", name: "Ogradni panel 3D 830x2500 5/5" },
            103: { price: 22.20, sku: "1009", name: "Ogradni panel 3D 1030x2500 5/5" },
            123: { price: 26.10, sku: "1011", name: "Ogradni panel 3D 1230x2500 5/5" },
            153: { price: 33.00, sku: "1013", name: "Ogradni panel 3D 1530x2500 5/5" },
            173: { price: 35.70, sku: "1015", name: "Ogradni panel 3D 1730x2500 5/5" },
            203: { price: 42.60, sku: "1017", name: "Ogradni panel 3D 2030x2500 5/5" }
        },

        // 3D PANELI (4mm)
        panel_3d_4: {
            83: { price: 12.30, sku: "1019", name: "Ogradni panel 3D 830x2500 4/4" },
            103: { price: 13.80, sku: "1008", name: "Ogradni panel 3D 1030x2500 4/4" },
            123: { price: 15.90, sku: "1010", name: "Ogradni panel 3D 1230x2500 4/4" },
            153: { price: 20.40, sku: "1012", name: "Ogradni panel 3D 1530x2500 4/4" },
            173: { price: 22.80, sku: "1014", name: "Ogradni panel 3D 1730x2500 4/4" },
            203: { price: 26.70, sku: "1016", name: "Ogradni panel 3D 2030x2500 4/4" }
        },
        ...
        set_spojnica: { price: 0.585, sku: "1039", name: "PVC Spojnica (s vijkom)" },
        anker_vijci: { price: 0.63, sku: "1040", name: "SIDRENI VIJAK ZN M10" },
        zastita_ok: { price: 44.85, sku: "1041", name: "ZAŠTITA OD POGLEDA, REBRASTA, 26 m²" },
        pricvrsnica_traka: { price: 0.7475, sku: "1042", name: "PVC PRIČVRSNICA ZA TRAKU" },
    ...
    chemicals: {
        ...
        pu_primer: { price: 12.03, sku: "2129", name: "Isomat PU pimer, 5kg" },
        isoflex_pu500: { price: 7.64, sku: "2130", name: "Isomat: Isoflex PU500, bijeli, (poliuretan)" },
        fimizol: { price: 21.94, sku: "2131", name: "FIMIZOL, 9L, bitumenski premaz" }
    },
    ...
    others: {
        ...
        osb_12: { price: 5.94, sku: "3010", name: "OSB ploče 12mm (2500 x 675mm)" },
